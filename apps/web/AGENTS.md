...
Demand inspect (`src/lab/demand-inspect.ts`) samples Appointment Site via DemandEngine for the current lab hour. Roots are not placed and `WorkQueue` is not executed.
