...
Run from repo root. Filters use workspace `name` (`@apps/nestjs`, `@packages/ui`, `@packages/fivenines-engine`, …). CLIs live under `tools/scripts/`. Setup: [Build guide](help-build-it.md#run-locally) · Map: [AGENTS.md](../AGENTS.md) · Product (humans): [wiki](https://github.com/movahedan/fivenines/wiki). Deps: [DEPENDABOT.md](DEPENDABOT.md).
