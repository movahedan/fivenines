...
- At narrow mobile widths, racks and contract headers remain reachable through deliberate sizing/scrolling; task progress and safe areas do not obscure navigation. Verify contrast, keyboard focus/return, chart point access and reduced motion with actual components, not merely the export.
