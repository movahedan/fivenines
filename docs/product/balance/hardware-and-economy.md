...
At 120 root requests/hour, the first project's mean CPU requirement is 134.4 work/hour: 80% × 1 + 20% × 2 per root. This is 6.72% of general-small's 2000 work/hour. Its fixed income is 80/week, mean operating expense approximately 17.70/week, leaving approximately 62.30/week before incidents, research, and purchases. The 240 purchase pays back in about 3.85 operating weeks. This is intentionally forgiving rather than a 72-hour payback target.

A second community project at 240/hour adds 264 CPU work/hour. Combined CPU is 398.4/hour (19.92%); weekly fixed income is 190 and mean operating cost approximately 19.48, leaving approximately 170.52 before incidents and investment. This rewards shared infrastructure but also concentrates hardware-failure risk. Four resident app/database installations plus system reserve use 1024 MiB before active work and queues, leaving meaningful room on the 2048 MiB starter server.
...
The user selected resale at 80% of purchase price for healthy hardware and 60% for faulty hardware. A 240 server therefore sells for 192 or 144. Software, configuration, and data faults do not affect resale.
