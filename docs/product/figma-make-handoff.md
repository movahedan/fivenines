...
Design Five Nines, a game about running an infrastructure operations business for customers. Create a coherent, interactive desktop and mobile prototype using the attached product reference. Preserve its existing dark navy and restrained green console identity, with readable human-facing text and monospaced metrics. Use English throughout. The infrastructure system is the main play surface, with rack-shaped server containers and the current project's installed software inside them. These shapes do not introduce physical rack-space mechanics. Use the main project workspace rack as the shared server design across acquisition, Inventory and details; incomplete secondary export pages do not establish alternative visuals.
