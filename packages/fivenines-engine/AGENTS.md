...
- M4 (stacks on #104): [infrastructure preparation and operations](../../.cursor/plans/m4-infrastructure-preparation-and-operations.plan.md) — #71/#112 is merged into #111. [#113](https://github.com/movahedan/fivenines/issues/113) / [#114](https://github.com/movahedan/fivenines/pull/114) is the named `Game.tick` playlist on `TickContext` (operations slot empty until the queue). Ready is not flipped yet.
