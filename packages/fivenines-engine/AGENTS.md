...
- M4 (stacks on #104): [infrastructure preparation and operations](../../.cursor/plans/m4-infrastructure-preparation-and-operations.plan.md) — #71/#112 is merged into #111. [#113](https://github.com/movahedan/fivenines/issues/113) is the named `Game.tick` playlist (`simulateHour` / `advanceCalendar`, `Project.tickCalendar`, offer spawn on Game). Next is the ops queue. Ready is not flipped yet.
